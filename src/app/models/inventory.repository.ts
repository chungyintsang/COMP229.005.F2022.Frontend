...
export class InventoryRepository {
    ...
    setInventory(){
        ...
        // Use subscribe to get data when it is ready (as the data may take time to load)
    ...
    getItem(id: string): Inventory {
        // Angular only gives a reference to the id, so you need to assign a copy of id to it
